...
map.getView().fit([-4264645.436687, -1426224.120921, -4263371.122750, -1425472.710398], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Cadastro de Logradouros SEDUR-PMC</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (122 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Cadastro de Logradouros oficializados a partir de 2017 e em processo de oficialização. Veja também O BuscaCEP dos Correios';
            }
