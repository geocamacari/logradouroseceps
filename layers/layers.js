...
var format_EquipPubSadeset2025_17 = new ol.format.GeoJSON();
var features_EquipPubSadeset2025_17 = format_EquipPubSadeset2025_17.readFeatures(json_EquipPubSadeset2025_17, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_EquipPubSadeset2025_17 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EquipPubSadeset2025_17.addFeatures(features_EquipPubSadeset2025_17);
var lyr_EquipPubSadeset2025_17 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EquipPubSadeset2025_17,
maxResolution:14.00223307613098,
 minResolution:0.28004466152261964,

                style: style_EquipPubSadeset2025_17,
                popuplayertitle: 'Equip. Pub. Saúde (set./2025)',
                interactive: true,
                title: '<img src="styles/legend/EquipPubSadeset2025_17.png" /> Equip. Pub. Saúde (set./2025)'
            });
var format_ProjetosREFLORACamaari2023_18 = new ol.format.GeoJSON();
var features_ProjetosREFLORACamaari2023_18 = format_ProjetosREFLORACamaari2023_18.readFeatures(json_ProjetosREFLORACamaari2023_18, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ProjetosREFLORACamaari2023_18 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ProjetosREFLORACamaari2023_18.addFeatures(features_ProjetosREFLORACamaari2023_18);
var lyr_ProjetosREFLORACamaari2023_18 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ProjetosREFLORACamaari2023_18,
maxResolution:28.00446615226196,
 minResolution:0.28004466152261964,

                style: style_ProjetosREFLORACamaari2023_18,
                popuplayertitle: 'Projetos REFLORA Camaçari (2023)',
                interactive: true,
                title: '<img src="styles/legend/ProjetosREFLORACamaari2023_18.png" /> Projetos REFLORA Camaçari (2023)'
            });
...
var format_LogradourosHierarquizao_20 = new ol.format.GeoJSON();
var features_LogradourosHierarquizao_20 = format_LogradourosHierarquizao_20.readFeatures(json_LogradourosHierarquizao_20, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LogradourosHierarquizao_20 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LogradourosHierarquizao_20.addFeatures(features_LogradourosHierarquizao_20);
var lyr_LogradourosHierarquizao_20 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LogradourosHierarquizao_20,
maxResolution:11.201786460904787,
 minResolution:0.14002233076130982,

                style: style_LogradourosHierarquizao_20,
                popuplayertitle: 'Logradouros Hierarquização',
                interactive: true,
    title: 'Logradouros Hierarquização<br />\
    <img src="styles/legend/LogradourosHierarquizao_20_0.png" /> Rodovias / Vias Expressas<br />\
    <img src="styles/legend/LogradourosHierarquizao_20_1.png" /> Sist. Viário Urb. Principal (Arteriais)<br />\
    <img src="styles/legend/LogradourosHierarquizao_20_2.png" /> Sist. Viário Urb. Complementar (Coletoras)<br />\
    <img src="styles/legend/LogradourosHierarquizao_20_3.png" /> Outras vias urbanas (Vias Locais)<br />\
    <img src="styles/legend/LogradourosHierarquizao_20_4.png" /> Estradas e vias rurais<br />' });
var format_LogradourosOficializadoseouCepeados_21 = new ol.format.GeoJSON();
var features_LogradourosOficializadoseouCepeados_21 = format_LogradourosOficializadoseouCepeados_21.readFeatures(json_LogradourosOficializadoseouCepeados_21, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LogradourosOficializadoseouCepeados_21 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LogradourosOficializadoseouCepeados_21.addFeatures(features_LogradourosOficializadoseouCepeados_21);
var lyr_LogradourosOficializadoseouCepeados_21 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LogradourosOficializadoseouCepeados_21,
maxResolution:11.201786460904787,
 minResolution:0.14002233076130982,

                style: style_LogradourosOficializadoseouCepeados_21,
                popuplayertitle: 'Logradouros Oficializados e/ou Cepeados',
                interactive: true,
                title: '<img src="styles/legend/LogradourosOficializadoseouCepeados_21.png" /> Logradouros Oficializados e/ou Cepeados'
            });
var format_LinhaFrreaFCA_22 = new ol.format.GeoJSON();
var features_LinhaFrreaFCA_22 = format_LinhaFrreaFCA_22.readFeatures(json_LinhaFrreaFCA_22, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LinhaFrreaFCA_22 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LinhaFrreaFCA_22.addFeatures(features_LinhaFrreaFCA_22);
var lyr_LinhaFrreaFCA_22 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LinhaFrreaFCA_22,
maxResolution:70.0111653806549,
 minResolution:0.28004466152261964,

                style: style_LinhaFrreaFCA_22,
                popuplayertitle: 'Linha Férrea (FCA)',
                interactive: true,
                title: '<img src="styles/legend/LinhaFrreaFCA_22.png" /> Linha Férrea (FCA)'
            });
var format_EixosRodEstSEINFRABa2021_23 = new ol.format.GeoJSON();
var features_EixosRodEstSEINFRABa2021_23 = format_EixosRodEstSEINFRABa2021_23.readFeatures(json_EixosRodEstSEINFRABa2021_23, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_EixosRodEstSEINFRABa2021_23 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EixosRodEstSEINFRABa2021_23.addFeatures(features_EixosRodEstSEINFRABa2021_23);
var lyr_EixosRodEstSEINFRABa2021_23 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EixosRodEstSEINFRABa2021_23,
maxResolution:140.0223307613098,
 minResolution:0.28004466152261964,

                style: style_EixosRodEstSEINFRABa2021_23,
                popuplayertitle: 'Eixos Rod. Est. (SEINFRA-Ba/2021)',
                interactive: true,
                title: '<img src="styles/legend/EixosRodEstSEINFRABa2021_23.png" /> Eixos Rod. Est. (SEINFRA-Ba/2021)'
            });
var format_PassarelasemRodovias_24 = new ol.format.GeoJSON();
var features_PassarelasemRodovias_24 = format_PassarelasemRodovias_24.readFeatures(json_PassarelasemRodovias_24, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PassarelasemRodovias_24 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PassarelasemRodovias_24.addFeatures(features_PassarelasemRodovias_24);
var lyr_PassarelasemRodovias_24 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PassarelasemRodovias_24,
maxResolution:42.00669922839295,
 minResolution:0.28004466152261964,

                style: style_PassarelasemRodovias_24,
                popuplayertitle: 'Passarelas em Rodovias',
                interactive: true,
                title: '<img src="styles/legend/PassarelasemRodovias_24.png" /> Passarelas em Rodovias'
            });
var format_Paradasdenibusemrodovias2022_25 = new ol.format.GeoJSON();
var features_Paradasdenibusemrodovias2022_25 = format_Paradasdenibusemrodovias2022_25.readFeatures(json_Paradasdenibusemrodovias2022_25, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Paradasdenibusemrodovias2022_25 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Paradasdenibusemrodovias2022_25.addFeatures(features_Paradasdenibusemrodovias2022_25);
var lyr_Paradasdenibusemrodovias2022_25 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Paradasdenibusemrodovias2022_25,
maxResolution:21.003349614196473,
 minResolution:0.28004466152261964,

                style: style_Paradasdenibusemrodovias2022_25,
                popuplayertitle: 'Paradas de ônibus em rodovias (2022)',
                interactive: true,
                title: '<img src="styles/legend/Paradasdenibusemrodovias2022_25.png" /> Paradas de ônibus em rodovias (2022)'
            });
var format_Pontos_IdentificaodiversosSEIBa_26 = new ol.format.GeoJSON();
var features_Pontos_IdentificaodiversosSEIBa_26 = format_Pontos_IdentificaodiversosSEIBa_26.readFeatures(json_Pontos_IdentificaodiversosSEIBa_26, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Pontos_IdentificaodiversosSEIBa_26 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Pontos_IdentificaodiversosSEIBa_26.addFeatures(features_Pontos_IdentificaodiversosSEIBa_26);
cluster_Pontos_IdentificaodiversosSEIBa_26 = new ol.source.Cluster({
  distance: 30,
  source: jsonSource_Pontos_IdentificaodiversosSEIBa_26
});
var lyr_Pontos_IdentificaodiversosSEIBa_26 = new ol.layer.Vector({
                declutter: false,
                source:cluster_Pontos_IdentificaodiversosSEIBa_26,
maxResolution:8.401339845678589,
 minResolution:0.28004466152261964,

                style: style_Pontos_IdentificaodiversosSEIBa_26,
                popuplayertitle: 'Pontos_Identificação diversos (SEI/Ba)',
                interactive: true,
                title: '<img src="styles/legend/Pontos_IdentificaodiversosSEIBa_26.png" /> Pontos_Identificação diversos (SEI/Ba)'
            });
var format_PontosdeRefernciadiversosCPP2023_27 = new ol.format.GeoJSON();
var features_PontosdeRefernciadiversosCPP2023_27 = format_PontosdeRefernciadiversosCPP2023_27.readFeatures(json_PontosdeRefernciadiversosCPP2023_27, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PontosdeRefernciadiversosCPP2023_27 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PontosdeRefernciadiversosCPP2023_27.addFeatures(features_PontosdeRefernciadiversosCPP2023_27);
var lyr_PontosdeRefernciadiversosCPP2023_27 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PontosdeRefernciadiversosCPP2023_27,
maxResolution:8.401339845678589,
 minResolution:0.28004466152261964,

                style: style_PontosdeRefernciadiversosCPP2023_27,
                popuplayertitle: 'Pontos de Referência diversos (CPP/2023)',
                interactive: true,
                title: '<img src="styles/legend/PontosdeRefernciadiversosCPP2023_27.png" /> Pontos de Referência diversos (CPP/2023)'
            });
...
lyr_OpenTopoMap_0.setVisible(false);lyr_WazeWorld_1.setVisible(false);lyr_OSMStandard_2.setVisible(true);lyr_GoogleSatellite_3.setVisible(true);lyr_GoogleTrafficonline_4.setVisible(false);lyr_GoogleLabels_5.setVisible(false);lyr_EsriBoundariesandPlaces_6.setVisible(true);lyr_RiosPerenesSEIBa25k_7.setVisible(false);lyr_Trecho_Massa_DaguaConder2010_8.setVisible(true);lyr_Massa_DaguaConder2010_9.setVisible(true);lyr_SIGEFPrivado_CamacariMar2025_10.setVisible(false);lyr_OutrosEquipInstitucionaiseComerciais2025_11.setVisible(false);lyr_EquipPubEsportejan23_12.setVisible(false);lyr_EquipPubPraasParquesoutrosjan23_13.setVisible(false);lyr_EquipPubCulturaisout21_14.setVisible(false);lyr_EquipPubAssistSocialout23_15.setVisible(false);lyr_EquipEducaoout23_16.setVisible(false);lyr_EquipPubSadeset2025_17.setVisible(false);lyr_ProjetosREFLORACamaari2023_18.setVisible(true);lyr_PraasdePedgiorodestaduais_19.setVisible(true);lyr_LogradourosHierarquizao_20.setVisible(false);lyr_LogradourosOficializadoseouCepeados_21.setVisible(true);lyr_LinhaFrreaFCA_22.setVisible(true);lyr_EixosRodEstSEINFRABa2021_23.setVisible(false);lyr_PassarelasemRodovias_24.setVisible(true);lyr_Paradasdenibusemrodovias2022_25.setVisible(true);lyr_Pontos_IdentificaodiversosSEIBa_26.setVisible(false);lyr_PontosdeRefernciadiversosCPP2023_27.setVisible(false);lyr_Localidadesdiversas2023_28.setVisible(true);lyr_MacrozonaIndustrialPDDUS2023_29.setVisible(false);lyr_MacrozonaUrbana_SEDE_30.setVisible(false);lyr_Bairros_Enderecamento_2022_CNEFE_31.setVisible(false);lyr_DistritosMunicipais2020_32.setVisible(false);lyr_LimitesMunicpiosRMS2020_33.setVisible(true);
var layersList = [lyr_OpenTopoMap_0,lyr_WazeWorld_1,lyr_OSMStandard_2,lyr_GoogleSatellite_3,lyr_GoogleTrafficonline_4,lyr_GoogleLabels_5,lyr_EsriBoundariesandPlaces_6,lyr_RiosPerenesSEIBa25k_7,lyr_Trecho_Massa_DaguaConder2010_8,lyr_Massa_DaguaConder2010_9,lyr_SIGEFPrivado_CamacariMar2025_10,lyr_OutrosEquipInstitucionaiseComerciais2025_11,lyr_EquipPubEsportejan23_12,lyr_EquipPubPraasParquesoutrosjan23_13,lyr_EquipPubCulturaisout21_14,lyr_EquipPubAssistSocialout23_15,lyr_EquipEducaoout23_16,lyr_EquipPubSadeset2025_17,lyr_ProjetosREFLORACamaari2023_18,lyr_PraasdePedgiorodestaduais_19,lyr_LogradourosHierarquizao_20,lyr_LogradourosOficializadoseouCepeados_21,lyr_LinhaFrreaFCA_22,lyr_EixosRodEstSEINFRABa2021_23,lyr_PassarelasemRodovias_24,lyr_Paradasdenibusemrodovias2022_25,lyr_Pontos_IdentificaodiversosSEIBa_26,lyr_PontosdeRefernciadiversosCPP2023_27,lyr_Localidadesdiversas2023_28,lyr_MacrozonaIndustrialPDDUS2023_29,lyr_MacrozonaUrbana_SEDE_30,lyr_Bairros_Enderecamento_2022_CNEFE_31,lyr_DistritosMunicipais2020_32,lyr_LimitesMunicpiosRMS2020_33];
...
lyr_EquipPubSadeset2025_17.set('fieldAliases', {'Name': 'Name', 'descriptio': 'descriptio', 'Instalacao': 'Instalacao', 'fonte': 'fonte', 'bairro': 'bairro', 'distrito': 'distrito', 'gestao': 'gestao', 'Org.': 'Org.', });
lyr_ProjetosREFLORACamaari2023_18.set('fieldAliases', {'Long': 'Long', 'Lat': 'Lat', 'Tipo': 'Tipo', 'Projeto': 'Projeto', });
...
lyr_LogradourosHierarquizao_20.set('fieldAliases', {'id': 'id', 'codlog_': 'codlog_', 'logradour_': 'logradour_', 'parcelame_': 'parcelame_', 'bairro_': 'bairro_', 'distrito_': 'distrito_', 'cep_': 'cep_', 'obs_1': 'obs_1', 'obs_2': 'obs_2', 'webmap': 'webmap', 'class.2': 'class.2', 'compriment': 'compriment', 'MAPA': 'MAPA', });
lyr_LogradourosOficializadoseouCepeados_21.set('fieldAliases', {'id': 'id', 'codlog_': 'codlog_', 'logradour_': 'logradour_', 'parcelame_': 'parcelame_', 'bairro_': 'bairro_', 'distrito_': 'distrito_', 'cep_': 'cep_', 'obs_1': 'obs_1', 'obs_2': 'obs_2', 'webmap': 'webmap', 'class.2': 'class.2', 'compriment': 'compriment', 'MAPA': 'MAPA', });
lyr_LinhaFrreaFCA_22.set('fieldAliases', {'id': 'id', 'nome': 'nome', 'nomeabrev': 'nomeabrev', 'geometriaa': 'geometriaa', 'codtrechof': 'codtrechof', 'posicaorel': 'posicaorel', 'tipotrecho': 'tipotrecho', 'bitola': 'bitola', 'eletrifica': 'eletrifica', 'nrlinhas': 'nrlinhas', 'emarruamen': 'emarruamen', 'jurisdicao': 'jurisdicao', 'administra': 'administra', 'concession': 'concession', 'operaciona': 'operaciona', 'situacaofi': 'situacaofi', 'cargasupor': 'cargasupor', });
lyr_EixosRodEstSEINFRABa2021_23.set('fieldAliases', {'Name': 'Name', 'fid': 'fid', 'Codigo SRE': 'Codigo SRE', 'UF': 'UF', 'Rodovia': 'Rodovia', 'Local Iní': 'Local Iní', 'Km Inicial': 'Km Inicial', 'Km Final': 'Km Final', 'Extensão': 'Extensão', 'Situação': 'Situação', 'Descriçã': 'Descriçã', 'Tipo de Re': 'Tipo de Re', 'Descriç_1': 'Descriç_1', 'Coincide_3': 'Coincide_3', 'Identifica': 'Identifica', 'Extensã_1': 'Extensã_1', 'Status': 'Status', });
lyr_PassarelasemRodovias_24.set('fieldAliases', {'id': 'id', 'Layer': 'Layer', 'Numero': 'Numero', 'Rodovia': 'Rodovia', 'Gestao': 'Gestao', 'Bairro': 'Bairro', 'Distrito': 'Distrito', });
lyr_Paradasdenibusemrodovias2022_25.set('fieldAliases', {'id': 'id', 'name': 'name', 'via': 'via', 'bairro_loc': 'bairro_loc', 'distrito': 'distrito', 'bases': 'bases', 'org.': 'org.', });
lyr_Pontos_IdentificaodiversosSEIBa_26.set('fieldAliases', {'id': 'id', 'nome': 'nome', 'nomeabrev': 'nomeabrev', 'geometriaa': 'geometriaa', 'operaciona': 'operaciona', 'situacaofi': 'situacaofi', 'matconstr': 'matconstr', });
lyr_PontosdeRefernciadiversosCPP2023_27.set('fieldAliases', {'id': 'id', 'nome': 'nome', 'tipo': 'tipo', 'bairro': 'bairro', 'distrito': 'distrito', 'base': 'base', 'fonte': 'fonte', });
...
lyr_SIGEFPrivado_CamacariMar2025_10.set('fieldImages', {'parcela_co': '', 'rt': '', 'art': '', 'situacao_i': '', 'codigo_imo': '', 'data_submi': '', 'data_aprov': '', 'status': '', 'nome_area': '', 'registro_m': '', 'registro_d': '', 'municipio_': '', 'uf_id': '', 'X': '', 'Y': '', });
...
lyr_EquipPubAssistSocialout23_15.set('fieldImages', {'id': 'TextEdit', 'unidade': 'TextEdit', 'local': 'TextEdit', 'contato': 'TextEdit', 'obs.': 'TextEdit', 'tipo': 'TextEdit', 'bairro': 'TextEdit', 'distrito': 'TextEdit', 'org.': 'TextEdit', 'Abrangenci': '', 'link': '', });
lyr_EquipEducaoout23_16.set('fieldImages', {'id': 'Range', 'tipo': 'TextEdit', 'cod_inep': 'TextEdit', 'nome_compl': 'TextEdit', 'distrito': 'TextEdit', 'numero': 'TextEdit', 'bairro': 'TextEdit', 'nome_anter': 'TextEdit', 'salas': 'TextEdit', 'endereco': 'TextEdit', 'turmas_exi': 'TextEdit', 'gestão': 'TextEdit', 'org.': 'TextEdit', 'LINK': '', 'Obs.': '', });
lyr_EquipPubSadeset2025_17.set('fieldImages', {'Name': 'TextEdit', 'descriptio': 'TextEdit', 'Instalacao': 'TextEdit', 'fonte': 'TextEdit', 'bairro': 'TextEdit', 'distrito': 'TextEdit', 'gestao': 'TextEdit', 'Org.': 'TextEdit', });
lyr_ProjetosREFLORACamaari2023_18.set('fieldImages', {'Long': 'Range', 'Lat': 'Range', 'Tipo': 'TextEdit', 'Projeto': 'TextEdit', });
...
lyr_LogradourosHierarquizao_20.set('fieldImages', {'id': 'TextEdit', 'codlog_': 'TextEdit', 'logradour_': 'TextEdit', 'parcelame_': 'TextEdit', 'bairro_': 'TextEdit', 'distrito_': 'TextEdit', 'cep_': 'TextEdit', 'obs_1': 'TextEdit', 'obs_2': 'TextEdit', 'webmap': 'TextEdit', 'class.2': '', 'compriment': 'TextEdit', 'MAPA': 'TextEdit', });
lyr_LogradourosOficializadoseouCepeados_21.set('fieldImages', {'id': 'TextEdit', 'codlog_': 'TextEdit', 'logradour_': 'TextEdit', 'parcelame_': 'TextEdit', 'bairro_': 'TextEdit', 'distrito_': 'TextEdit', 'cep_': 'TextEdit', 'obs_1': 'TextEdit', 'obs_2': 'TextEdit', 'webmap': 'TextEdit', 'class.2': '', 'compriment': 'TextEdit', 'MAPA': '', });
lyr_LinhaFrreaFCA_22.set('fieldImages', {'id': 'TextEdit', 'nome': 'TextEdit', 'nomeabrev': 'TextEdit', 'geometriaa': 'TextEdit', 'codtrechof': 'TextEdit', 'posicaorel': 'TextEdit', 'tipotrecho': 'TextEdit', 'bitola': 'TextEdit', 'eletrifica': 'TextEdit', 'nrlinhas': 'TextEdit', 'emarruamen': 'TextEdit', 'jurisdicao': 'TextEdit', 'administra': 'TextEdit', 'concession': 'TextEdit', 'operaciona': 'TextEdit', 'situacaofi': 'TextEdit', 'cargasupor': 'TextEdit', });
lyr_EixosRodEstSEINFRABa2021_23.set('fieldImages', {'Name': 'TextEdit', 'fid': 'TextEdit', 'Codigo SRE': 'TextEdit', 'UF': 'TextEdit', 'Rodovia': 'TextEdit', 'Local Iní': 'TextEdit', 'Km Inicial': 'TextEdit', 'Km Final': 'TextEdit', 'Extensão': 'TextEdit', 'Situação': 'TextEdit', 'Descriçã': 'TextEdit', 'Tipo de Re': 'TextEdit', 'Descriç_1': 'TextEdit', 'Coincide_3': 'TextEdit', 'Identifica': 'TextEdit', 'Extensã_1': 'TextEdit', 'Status': 'TextEdit', });
lyr_PassarelasemRodovias_24.set('fieldImages', {'id': 'TextEdit', 'Layer': 'TextEdit', 'Numero': 'Range', 'Rodovia': 'TextEdit', 'Gestao': 'TextEdit', 'Bairro': 'TextEdit', 'Distrito': 'TextEdit', });
lyr_Paradasdenibusemrodovias2022_25.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'via': 'TextEdit', 'bairro_loc': 'TextEdit', 'distrito': 'TextEdit', 'bases': 'TextEdit', 'org.': 'TextEdit', });
lyr_Pontos_IdentificaodiversosSEIBa_26.set('fieldImages', {'id': 'TextEdit', 'nome': 'TextEdit', 'nomeabrev': 'TextEdit', 'geometriaa': 'TextEdit', 'operaciona': 'TextEdit', 'situacaofi': 'TextEdit', 'matconstr': 'TextEdit', });
lyr_PontosdeRefernciadiversosCPP2023_27.set('fieldImages', {'id': 'TextEdit', 'nome': 'TextEdit', 'tipo': 'TextEdit', 'bairro': 'TextEdit', 'distrito': 'TextEdit', 'base': 'TextEdit', 'fonte': 'TextEdit', });
...
lyr_EquipPubSadeset2025_17.set('fieldLabels', {'Name': 'inline label - always visible', 'descriptio': 'inline label - always visible', 'Instalacao': 'inline label - always visible', 'fonte': 'inline label - always visible', 'bairro': 'inline label - always visible', 'distrito': 'inline label - always visible', 'gestao': 'inline label - always visible', 'Org.': 'inline label - always visible', });
lyr_ProjetosREFLORACamaari2023_18.set('fieldLabels', {'Long': 'hidden field', 'Lat': 'hidden field', 'Tipo': 'inline label - always visible', 'Projeto': 'inline label - always visible', });
...
lyr_LogradourosHierarquizao_20.set('fieldLabels', {'id': 'hidden field', 'codlog_': 'inline label - always visible', 'logradour_': 'inline label - always visible', 'parcelame_': 'inline label - always visible', 'bairro_': 'inline label - always visible', 'distrito_': 'inline label - always visible', 'cep_': 'inline label - always visible', 'obs_1': 'inline label - always visible', 'obs_2': 'inline label - always visible', 'webmap': 'inline label - always visible', 'class.2': 'inline label - always visible', 'compriment': 'inline label - always visible', 'MAPA': 'inline label - always visible', });
lyr_LogradourosOficializadoseouCepeados_21.set('fieldLabels', {'id': 'hidden field', 'codlog_': 'inline label - always visible', 'logradour_': 'inline label - always visible', 'parcelame_': 'inline label - always visible', 'bairro_': 'inline label - always visible', 'distrito_': 'inline label - always visible', 'cep_': 'inline label - always visible', 'obs_1': 'inline label - always visible', 'obs_2': 'inline label - always visible', 'webmap': 'inline label - always visible', 'class.2': 'inline label - always visible', 'compriment': 'inline label - always visible', 'MAPA': 'inline label - always visible', });
lyr_LinhaFrreaFCA_22.set('fieldLabels', {'id': 'inline label - always visible', 'nome': 'inline label - always visible', 'nomeabrev': 'inline label - always visible', 'geometriaa': 'inline label - always visible', 'codtrechof': 'inline label - always visible', 'posicaorel': 'inline label - always visible', 'tipotrecho': 'inline label - always visible', 'bitola': 'inline label - always visible', 'eletrifica': 'inline label - always visible', 'nrlinhas': 'inline label - always visible', 'emarruamen': 'inline label - always visible', 'jurisdicao': 'inline label - always visible', 'administra': 'inline label - always visible', 'concession': 'inline label - always visible', 'operaciona': 'inline label - always visible', 'situacaofi': 'inline label - always visible', 'cargasupor': 'inline label - always visible', });
lyr_EixosRodEstSEINFRABa2021_23.set('fieldLabels', {'Name': 'inline label - always visible', 'fid': 'inline label - always visible', 'Codigo SRE': 'inline label - always visible', 'UF': 'inline label - always visible', 'Rodovia': 'inline label - always visible', 'Local Iní': 'inline label - always visible', 'Km Inicial': 'inline label - always visible', 'Km Final': 'inline label - always visible', 'Extensão': 'inline label - always visible', 'Situação': 'inline label - always visible', 'Descriçã': 'inline label - always visible', 'Tipo de Re': 'inline label - always visible', 'Descriç_1': 'inline label - always visible', 'Coincide_3': 'inline label - always visible', 'Identifica': 'inline label - always visible', 'Extensã_1': 'inline label - always visible', 'Status': 'inline label - always visible', });
lyr_PassarelasemRodovias_24.set('fieldLabels', {'id': 'inline label - always visible', 'Layer': 'inline label - always visible', 'Numero': 'inline label - always visible', 'Rodovia': 'inline label - always visible', 'Gestao': 'inline label - always visible', 'Bairro': 'inline label - always visible', 'Distrito': 'inline label - always visible', });
lyr_Paradasdenibusemrodovias2022_25.set('fieldLabels', {'id': 'hidden field', 'name': 'hidden field', 'via': 'hidden field', 'bairro_loc': 'hidden field', 'distrito': 'hidden field', 'bases': 'hidden field', 'org.': 'hidden field', });
lyr_Pontos_IdentificaodiversosSEIBa_26.set('fieldLabels', {'id': 'hidden field', 'nome': 'inline label - always visible', 'nomeabrev': 'hidden field', 'geometriaa': 'hidden field', 'operaciona': 'hidden field', 'situacaofi': 'hidden field', 'matconstr': 'hidden field', });
lyr_PontosdeRefernciadiversosCPP2023_27.set('fieldLabels', {'id': 'hidden field', 'nome': 'inline label - always visible', 'tipo': 'inline label - always visible', 'bairro': 'hidden field', 'distrito': 'hidden field', 'base': 'hidden field', 'fonte': 'hidden field', });
...
lyr_MacrozonaUrbana_SEDE_30.set('fieldLabels', {'Id': 'inline label - always visible', 'layer': 'inline label - always visible', 'perímetro': 'inline label - always visible', 'área_elli': 'inline label - always visible', 'area_km2': 'inline label - always visible', 'perimetro': 'inline label - always visible', 'percentual': 'inline label - always visible', });
lyr_Bairros_Enderecamento_2022_CNEFE_31.set('fieldLabels', {'id': 'hidden field', 'nm_bairro': 'inline label - always visible', 'cod_bairro': 'hidden field', 'distrito': 'inline label - always visible', 'situação': 'hidden field', 'bairros': 'hidden field', 'rotulos': 'hidden field', 'CNEFE 2022': 'inline label - always visible', 'Hab_Dom': 'hidden field', 'PopEst_22': 'inline label - always visible', 'area_Ha': 'inline label - always visible', 'Perim_km': 'inline label - always visible', 'Pop_est_24': 'inline label - always visible', 'area_km2': 'inline label - always visible', 'Dens_km2': 'inline label - always visible', 'Dens_Ha': 'inline label - always visible', 'hab_dom_1': 'hidden field', });
