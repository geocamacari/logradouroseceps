...
var format_SigefPrivado_Camacari_260325_9 = new ol.format.GeoJSON();
var features_SigefPrivado_Camacari_260325_9 = format_SigefPrivado_Camacari_260325_9.readFeatures(json_SigefPrivado_Camacari_260325_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SigefPrivado_Camacari_260325_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SigefPrivado_Camacari_260325_9.addFeatures(features_SigefPrivado_Camacari_260325_9);
var lyr_SigefPrivado_Camacari_260325_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SigefPrivado_Camacari_260325_9,
maxResolution:28.00446615226196,
 minResolution:0.28004466152261964,

                style: style_SigefPrivado_Camacari_260325_9,
                popuplayertitle: 'Sigef Privado_Camacari_26-03-25',
                interactive: true,
                title: '<img src="styles/legend/SigefPrivado_Camacari_260325_9.png" /> Sigef Privado_Camacari_26-03-25'
            });
var format_OutrosEquipInstitucionaiseComerciais2025_10 = new ol.format.GeoJSON();
var features_OutrosEquipInstitucionaiseComerciais2025_10 = format_OutrosEquipInstitucionaiseComerciais2025_10.readFeatures(json_OutrosEquipInstitucionaiseComerciais2025_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_OutrosEquipInstitucionaiseComerciais2025_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_OutrosEquipInstitucionaiseComerciais2025_10.addFeatures(features_OutrosEquipInstitucionaiseComerciais2025_10);
var lyr_OutrosEquipInstitucionaiseComerciais2025_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_OutrosEquipInstitucionaiseComerciais2025_10,
maxResolution:7.00111653806549,
 minResolution:0.28004466152261964,

                style: style_OutrosEquipInstitucionaiseComerciais2025_10,
                popuplayertitle: 'Outros Equip. Institucionais e Comerciais (2025)',
                interactive: true,
                title: '<img src="styles/legend/OutrosEquipInstitucionaiseComerciais2025_10.png" /> Outros Equip. Institucionais e Comerciais (2025)'
            });
var format_EquipPubEsportejan23_11 = new ol.format.GeoJSON();
var features_EquipPubEsportejan23_11 = format_EquipPubEsportejan23_11.readFeatures(json_EquipPubEsportejan23_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_EquipPubEsportejan23_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EquipPubEsportejan23_11.addFeatures(features_EquipPubEsportejan23_11);
var lyr_EquipPubEsportejan23_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EquipPubEsportejan23_11,
maxResolution:7.00111653806549,
 minResolution:0.28004466152261964,

                style: style_EquipPubEsportejan23_11,
                popuplayertitle: 'Equip. Pub. Esporte (jan/23)',
                interactive: true,
                title: '<img src="styles/legend/EquipPubEsportejan23_11.png" /> Equip. Pub. Esporte (jan/23)'
            });
var format_EquipPubPraasParquesoutrosjan23_12 = new ol.format.GeoJSON();
var features_EquipPubPraasParquesoutrosjan23_12 = format_EquipPubPraasParquesoutrosjan23_12.readFeatures(json_EquipPubPraasParquesoutrosjan23_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_EquipPubPraasParquesoutrosjan23_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EquipPubPraasParquesoutrosjan23_12.addFeatures(features_EquipPubPraasParquesoutrosjan23_12);
var lyr_EquipPubPraasParquesoutrosjan23_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EquipPubPraasParquesoutrosjan23_12,
maxResolution:7.00111653806549,
 minResolution:0.28004466152261964,

                style: style_EquipPubPraasParquesoutrosjan23_12,
                popuplayertitle: 'Equip. Pub. Praças/Parques/outros (jan/23)',
                interactive: true,
                title: '<img src="styles/legend/EquipPubPraasParquesoutrosjan23_12.png" /> Equip. Pub. Praças/Parques/outros (jan/23)'
            });
var format_EquipPubCulturaisout21_13 = new ol.format.GeoJSON();
var features_EquipPubCulturaisout21_13 = format_EquipPubCulturaisout21_13.readFeatures(json_EquipPubCulturaisout21_13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_EquipPubCulturaisout21_13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EquipPubCulturaisout21_13.addFeatures(features_EquipPubCulturaisout21_13);
var lyr_EquipPubCulturaisout21_13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EquipPubCulturaisout21_13,
maxResolution:7.00111653806549,
 minResolution:0.28004466152261964,

                style: style_EquipPubCulturaisout21_13,
                popuplayertitle: 'Equip. Pub. Culturais (out/21)',
                interactive: true,
                title: '<img src="styles/legend/EquipPubCulturaisout21_13.png" /> Equip. Pub. Culturais (out/21)'
            });
var format_EquipPubAssistSocialout23_14 = new ol.format.GeoJSON();
var features_EquipPubAssistSocialout23_14 = format_EquipPubAssistSocialout23_14.readFeatures(json_EquipPubAssistSocialout23_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_EquipPubAssistSocialout23_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EquipPubAssistSocialout23_14.addFeatures(features_EquipPubAssistSocialout23_14);
var lyr_EquipPubAssistSocialout23_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EquipPubAssistSocialout23_14,
maxResolution:7.00111653806549,
 minResolution:0.28004466152261964,

                style: style_EquipPubAssistSocialout23_14,
                popuplayertitle: 'Equip. Pub. Assist Social (out/23)',
                interactive: true,
                title: '<img src="styles/legend/EquipPubAssistSocialout23_14.png" /> Equip. Pub. Assist Social (out/23)'
            });
var format_EquipEducaoout23_15 = new ol.format.GeoJSON();
var features_EquipEducaoout23_15 = format_EquipEducaoout23_15.readFeatures(json_EquipEducaoout23_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_EquipEducaoout23_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EquipEducaoout23_15.addFeatures(features_EquipEducaoout23_15);
var lyr_EquipEducaoout23_15 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EquipEducaoout23_15,
maxResolution:14.00223307613098,
 minResolution:0.28004466152261964,

                style: style_EquipEducaoout23_15,
                popuplayertitle: 'Equip. Educação (out/23)',
                interactive: true,
                title: '<img src="styles/legend/EquipEducaoout23_15.png" /> Equip. Educação (out/23)'
            });
var format_EquipPubSadeout23_16 = new ol.format.GeoJSON();
var features_EquipPubSadeout23_16 = format_EquipPubSadeout23_16.readFeatures(json_EquipPubSadeout23_16, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_EquipPubSadeout23_16 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EquipPubSadeout23_16.addFeatures(features_EquipPubSadeout23_16);
var lyr_EquipPubSadeout23_16 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EquipPubSadeout23_16,
maxResolution:14.00223307613098,
 minResolution:0.28004466152261964,

                style: style_EquipPubSadeout23_16,
                popuplayertitle: 'Equip. Pub. Saúde (out/23)',
                interactive: true,
                title: '<img src="styles/legend/EquipPubSadeout23_16.png" /> Equip. Pub. Saúde (out/23)'
            });
var format_ProjetosREFLORACamaari2023_17 = new ol.format.GeoJSON();
var features_ProjetosREFLORACamaari2023_17 = format_ProjetosREFLORACamaari2023_17.readFeatures(json_ProjetosREFLORACamaari2023_17, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ProjetosREFLORACamaari2023_17 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ProjetosREFLORACamaari2023_17.addFeatures(features_ProjetosREFLORACamaari2023_17);
var lyr_ProjetosREFLORACamaari2023_17 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ProjetosREFLORACamaari2023_17,
maxResolution:28.00446615226196,
 minResolution:0.28004466152261964,

                style: style_ProjetosREFLORACamaari2023_17,
                popuplayertitle: 'Projetos REFLORA Camaçari (2023)',
                interactive: true,
                title: '<img src="styles/legend/ProjetosREFLORACamaari2023_17.png" /> Projetos REFLORA Camaçari (2023)'
            });
var format_PraasdePedgiorodestaduais_18 = new ol.format.GeoJSON();
var features_PraasdePedgiorodestaduais_18 = format_PraasdePedgiorodestaduais_18.readFeatures(json_PraasdePedgiorodestaduais_18, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PraasdePedgiorodestaduais_18 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PraasdePedgiorodestaduais_18.addFeatures(features_PraasdePedgiorodestaduais_18);
var lyr_PraasdePedgiorodestaduais_18 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PraasdePedgiorodestaduais_18,
maxResolution:56.00893230452392,
 minResolution:0.28004466152261964,

                style: style_PraasdePedgiorodestaduais_18,
                popuplayertitle: 'Praças de Pedágio (rod. estaduais)',
                interactive: true,
                title: '<img src="styles/legend/PraasdePedgiorodestaduais_18.png" /> Praças de Pedágio (rod. estaduais)'
            });
var format_LogradourosHierarquizao_19 = new ol.format.GeoJSON();
var features_LogradourosHierarquizao_19 = format_LogradourosHierarquizao_19.readFeatures(json_LogradourosHierarquizao_19, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LogradourosHierarquizao_19 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LogradourosHierarquizao_19.addFeatures(features_LogradourosHierarquizao_19);
var lyr_LogradourosHierarquizao_19 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LogradourosHierarquizao_19,
maxResolution:11.201786460904787,
 minResolution:0.14002233076130982,

                style: style_LogradourosHierarquizao_19,
                popuplayertitle: 'Logradouros Hierarquização',
                interactive: true,
    title: 'Logradouros Hierarquização<br />\
    <img src="styles/legend/LogradourosHierarquizao_19_0.png" /> Rodovias / Vias Expressas<br />\
    <img src="styles/legend/LogradourosHierarquizao_19_1.png" /> Sist. Viário Urb. Principal (Arteriais)<br />\
    <img src="styles/legend/LogradourosHierarquizao_19_2.png" /> Sist. Viário Urb. Complementar (Coletoras)<br />\
    <img src="styles/legend/LogradourosHierarquizao_19_3.png" /> Outras vias urbanas (Vias Locais)<br />\
    <img src="styles/legend/LogradourosHierarquizao_19_4.png" /> Estradas e vias rurais<br />' });
...
jsonSource_Localidadesdiversas2023_25.addFeatures(features_Localidadesdiversas2023_25);
cluster_Localidadesdiversas2023_25 = new ol.source.Cluster({
  distance: 30,
...
lyr_OSMStandard_0.setVisible(true);lyr_WazeWorld_1.setVisible(false);lyr_GoogleSatellite_2.setVisible(true);lyr_GoogleTrafficonline_3.setVisible(false);lyr_GoogleLabels_4.setVisible(false);lyr_EsriBoundariesandPlaces_5.setVisible(true);lyr_RiosPerenesSEIBa25k_6.setVisible(false);lyr_Trecho_Massa_DaguaConder2010_7.setVisible(true);lyr_Massa_DaguaConder2010_8.setVisible(true);lyr_SigefPrivado_Camacari_260325_9.setVisible(false);lyr_OutrosEquipInstitucionaiseComerciais2025_10.setVisible(false);lyr_EquipPubEsportejan23_11.setVisible(false);lyr_EquipPubPraasParquesoutrosjan23_12.setVisible(false);lyr_EquipPubCulturaisout21_13.setVisible(false);lyr_EquipPubAssistSocialout23_14.setVisible(false);lyr_EquipEducaoout23_15.setVisible(false);lyr_EquipPubSadeout23_16.setVisible(false);lyr_ProjetosREFLORACamaari2023_17.setVisible(true);lyr_PraasdePedgiorodestaduais_18.setVisible(true);lyr_LogradourosHierarquizao_19.setVisible(false);lyr_LogradourosOficializadoseouCepeados_20.setVisible(true);lyr_LinhaFrreaFCA_21.setVisible(true);lyr_EixosRodEstSEINFRABa2021_22.setVisible(false);lyr_PassarelasemRodovias_23.setVisible(true);lyr_Paradasdenibusemrodovias2022_24.setVisible(true);lyr_Localidadesdiversas2023_25.setVisible(true);lyr_Bairros_Enderecamento_2022_CNEFE_26.setVisible(false);lyr_DistritosMunicipais2020_27.setVisible(false);lyr_LimitesMunicpiosRMS2020_28.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_WazeWorld_1,lyr_GoogleSatellite_2,lyr_GoogleTrafficonline_3,lyr_GoogleLabels_4,lyr_EsriBoundariesandPlaces_5,lyr_RiosPerenesSEIBa25k_6,lyr_Trecho_Massa_DaguaConder2010_7,lyr_Massa_DaguaConder2010_8,lyr_SigefPrivado_Camacari_260325_9,lyr_OutrosEquipInstitucionaiseComerciais2025_10,lyr_EquipPubEsportejan23_11,lyr_EquipPubPraasParquesoutrosjan23_12,lyr_EquipPubCulturaisout21_13,lyr_EquipPubAssistSocialout23_14,lyr_EquipEducaoout23_15,lyr_EquipPubSadeout23_16,lyr_ProjetosREFLORACamaari2023_17,lyr_PraasdePedgiorodestaduais_18,lyr_LogradourosHierarquizao_19,lyr_LogradourosOficializadoseouCepeados_20,lyr_LinhaFrreaFCA_21,lyr_EixosRodEstSEINFRABa2021_22,lyr_PassarelasemRodovias_23,lyr_Paradasdenibusemrodovias2022_24,lyr_Localidadesdiversas2023_25,lyr_Bairros_Enderecamento_2022_CNEFE_26,lyr_DistritosMunicipais2020_27,lyr_LimitesMunicpiosRMS2020_28];
...
lyr_SigefPrivado_Camacari_260325_9.set('fieldAliases', {'parcela_co': 'parcela_co', 'rt': 'rt', 'art': 'art', 'situacao_i': 'situacao_i', 'codigo_imo': 'codigo_imo', 'data_submi': 'data_submi', 'data_aprov': 'data_aprov', 'status': 'status', 'nome_area': 'nome_area', 'registro_m': 'registro_m', 'registro_d': 'registro_d', 'municipio_': 'municipio_', 'uf_id': 'uf_id', 'X': 'X', 'Y': 'Y', });
lyr_OutrosEquipInstitucionaiseComerciais2025_10.set('fieldAliases', {'id': 'id', 'nome': 'nome', 'tipo': 'tipo', 'setor': 'setor', 'bairro': 'bairro', 'distrito': 'distrito', 'situação': 'situação', 'gestão': 'gestão', 'observaç�': 'observaç�', 'fonte': 'fonte', 'revisão': 'revisão', });
lyr_EquipPubEsportejan23_11.set('fieldAliases', {'id': 'id', 'name': 'name', 'layer': 'layer', 'bairro': 'bairro', 'fonte': 'fonte', 'distrito': 'distrito', 'obs': 'obs', 'revisão': 'revisão', 'org.': 'org.', 'Macrozona': 'Macrozona', });
lyr_EquipPubPraasParquesoutrosjan23_12.set('fieldAliases', {'id': 'id', 'name': 'name', 'bairro': 'bairro', 'fonte': 'fonte', 'layer_': 'layer_', 'distrito': 'distrito', 'observaç�': 'observaç�', 'revisão': 'revisão', 'estrutura': 'estrutura', 'org.': 'org.', 'Macrozona': 'Macrozona', });
lyr_EquipPubCulturaisout21_13.set('fieldAliases', {'id': 'id', 'uso': 'uso', 'tipo': 'tipo', 'fonte': 'fonte', 'origem': 'origem', 'bairro': 'bairro', 'distrito': 'distrito', 'observaç�': 'observaç�', 'turno': 'turno', 'endereço': 'endereço', 'capacidade': 'capacidade', 'gestão': 'gestão', 'equipament': 'equipament', 'org.': 'org.', });
lyr_EquipPubAssistSocialout23_14.set('fieldAliases', {'id': 'id', 'unidade': 'unidade', 'local': 'local', 'contato': 'contato', 'obs.': 'obs.', 'tipo': 'tipo', 'bairro': 'bairro', 'distrito': 'distrito', 'org.': 'org.', 'Abrangenci': 'Abrangenci', 'link': 'link', });
lyr_EquipEducaoout23_15.set('fieldAliases', {'id': 'id', 'tipo': 'tipo', 'cod_inep': 'cod_inep', 'nome_compl': 'nome_compl', 'distrito': 'distrito', 'numero': 'numero', 'bairro': 'bairro', 'nome_anter': 'nome_anter', 'salas': 'salas', 'endereco': 'endereco', 'turmas_exi': 'turmas_exi', 'gestão': 'gestão', 'org.': 'org.', 'LINK': 'LINK', 'Obs.': 'Obs.', });
lyr_EquipPubSadeout23_16.set('fieldAliases', {'id': 'id', 'name': 'name', 'descriptio': 'descriptio', 'tipo': 'tipo', 'fonte': 'fonte', 'bairro': 'bairro', 'distrito': 'distrito', 'cnes': 'cnes', 'n. gestão': 'n. gestão', 'org.': 'org.', 'LINK': 'LINK', 'LINK_2': 'LINK_2', });
lyr_ProjetosREFLORACamaari2023_17.set('fieldAliases', {'Long': 'Long', 'Lat': 'Lat', 'Tipo': 'Tipo', 'Projeto': 'Projeto', });
lyr_PraasdePedgiorodestaduais_18.set('fieldAliases', {'id': 'id', 'nome': 'nome', 'tipo': 'tipo', 'bairro': 'bairro', 'distrito': 'distrito', 'base': 'base', 'fonte': 'fonte', });
lyr_LogradourosHierarquizao_19.set('fieldAliases', {'id': 'id', 'codlog_': 'codlog_', 'logradour_': 'logradour_', 'parcelame_': 'parcelame_', 'bairro_': 'bairro_', 'distrito_': 'distrito_', 'cep_': 'cep_', 'obs_1': 'obs_1', 'obs_2': 'obs_2', 'webmap': 'webmap', 'class.2': 'class.2', 'compriment': 'compriment', 'MAPA': 'MAPA', });
...
lyr_SigefPrivado_Camacari_260325_9.set('fieldImages', {'parcela_co': '', 'rt': '', 'art': '', 'situacao_i': '', 'codigo_imo': '', 'data_submi': '', 'data_aprov': '', 'status': '', 'nome_area': '', 'registro_m': '', 'registro_d': '', 'municipio_': '', 'uf_id': '', 'X': '', 'Y': '', });
lyr_OutrosEquipInstitucionaiseComerciais2025_10.set('fieldImages', {'id': 'TextEdit', 'nome': 'TextEdit', 'tipo': 'TextEdit', 'setor': 'TextEdit', 'bairro': 'TextEdit', 'distrito': 'TextEdit', 'situação': 'TextEdit', 'gestão': 'TextEdit', 'observaç�': 'TextEdit', 'fonte': 'TextEdit', 'revisão': 'TextEdit', });
lyr_EquipPubEsportejan23_11.set('fieldImages', {'id': 'Range', 'name': 'TextEdit', 'layer': 'TextEdit', 'bairro': 'TextEdit', 'fonte': 'TextEdit', 'distrito': 'TextEdit', 'obs': 'TextEdit', 'revisão': 'TextEdit', 'org.': 'TextEdit', 'Macrozona': 'TextEdit', });
lyr_EquipPubPraasParquesoutrosjan23_12.set('fieldImages', {'id': 'Range', 'name': 'TextEdit', 'bairro': 'TextEdit', 'fonte': 'TextEdit', 'layer_': 'TextEdit', 'distrito': 'TextEdit', 'observaç�': 'TextEdit', 'revisão': 'TextEdit', 'estrutura': 'TextEdit', 'org.': 'TextEdit', 'Macrozona': 'TextEdit', });
lyr_EquipPubCulturaisout21_13.set('fieldImages', {'id': 'TextEdit', 'uso': 'TextEdit', 'tipo': 'TextEdit', 'fonte': 'TextEdit', 'origem': 'TextEdit', 'bairro': 'TextEdit', 'distrito': 'TextEdit', 'observaç�': 'TextEdit', 'turno': 'TextEdit', 'endereço': 'TextEdit', 'capacidade': 'TextEdit', 'gestão': 'TextEdit', 'equipament': 'TextEdit', 'org.': 'TextEdit', });
lyr_EquipPubAssistSocialout23_14.set('fieldImages', {'id': 'TextEdit', 'unidade': 'TextEdit', 'local': 'TextEdit', 'contato': 'TextEdit', 'obs.': 'TextEdit', 'tipo': 'TextEdit', 'bairro': 'TextEdit', 'distrito': 'TextEdit', 'org.': 'TextEdit', 'Abrangenci': '', 'link': '', });
lyr_EquipEducaoout23_15.set('fieldImages', {'id': 'Range', 'tipo': 'TextEdit', 'cod_inep': 'TextEdit', 'nome_compl': 'TextEdit', 'distrito': 'TextEdit', 'numero': 'TextEdit', 'bairro': 'TextEdit', 'nome_anter': 'TextEdit', 'salas': 'TextEdit', 'endereco': 'TextEdit', 'turmas_exi': 'TextEdit', 'gestão': 'TextEdit', 'org.': 'TextEdit', 'LINK': '', 'Obs.': '', });
lyr_EquipPubSadeout23_16.set('fieldImages', {'id': 'Range', 'name': 'TextEdit', 'descriptio': 'TextEdit', 'tipo': 'TextEdit', 'fonte': 'TextEdit', 'bairro': 'TextEdit', 'distrito': 'TextEdit', 'cnes': 'TextEdit', 'n. gestão': 'TextEdit', 'org.': 'TextEdit', 'LINK': '', 'LINK_2': '', });
lyr_ProjetosREFLORACamaari2023_17.set('fieldImages', {'Long': 'Range', 'Lat': 'Range', 'Tipo': 'TextEdit', 'Projeto': 'TextEdit', });
lyr_PraasdePedgiorodestaduais_18.set('fieldImages', {'id': 'TextEdit', 'nome': 'TextEdit', 'tipo': 'TextEdit', 'bairro': 'TextEdit', 'distrito': 'TextEdit', 'base': 'TextEdit', 'fonte': 'TextEdit', });
lyr_LogradourosHierarquizao_19.set('fieldImages', {'id': 'TextEdit', 'codlog_': 'TextEdit', 'logradour_': 'TextEdit', 'parcelame_': 'TextEdit', 'bairro_': 'TextEdit', 'distrito_': 'TextEdit', 'cep_': 'TextEdit', 'obs_1': 'TextEdit', 'obs_2': 'TextEdit', 'webmap': 'TextEdit', 'class.2': '', 'compriment': 'TextEdit', 'MAPA': 'TextEdit', });
lyr_LogradourosOficializadoseouCepeados_20.set('fieldImages', {'id': 'TextEdit', 'codlog_': 'TextEdit', 'logradour_': 'TextEdit', 'parcelame_': 'TextEdit', 'bairro_': 'TextEdit', 'distrito_': 'TextEdit', 'cep_': 'TextEdit', 'obs_1': 'TextEdit', 'obs_2': 'TextEdit', 'webmap': 'TextEdit', 'class.2': '', 'compriment': 'TextEdit', 'MAPA': '', });
...
lyr_Bairros_Enderecamento_2022_CNEFE_26.set('fieldImages', {'id': 'TextEdit', 'nm_bairro': 'TextEdit', 'cod_bairro': 'TextEdit', 'distrito': 'TextEdit', 'situação': 'TextEdit', 'bairros': 'TextEdit', 'rotulos': 'TextEdit', 'CNEFE 2022': '', 'Hab_Dom': '', 'PopEst_22': '', 'area_Ha': '', 'Perim_km': '', 'Pop_est_24': '', 'area_km2': '', 'Dens_km2': '', 'Dens_Ha': '', 'hab_dom_1': '', });
...
lyr_SigefPrivado_Camacari_260325_9.set('fieldLabels', {'parcela_co': 'inline label - always visible', 'rt': 'inline label - always visible', 'art': 'inline label - always visible', 'situacao_i': 'inline label - always visible', 'codigo_imo': 'inline label - always visible', 'data_submi': 'inline label - always visible', 'data_aprov': 'inline label - always visible', 'status': 'inline label - always visible', 'nome_area': 'inline label - always visible', 'registro_m': 'inline label - always visible', 'registro_d': 'inline label - always visible', 'municipio_': 'inline label - always visible', 'uf_id': 'inline label - always visible', 'X': 'inline label - always visible', 'Y': 'no label', });
lyr_OutrosEquipInstitucionaiseComerciais2025_10.set('fieldLabels', {'id': 'inline label - always visible', 'nome': 'no label', 'tipo': 'inline label - always visible', 'setor': 'no label', 'bairro': 'hidden field', 'distrito': 'hidden field', 'situação': 'no label', 'gestão': 'inline label - always visible', 'observaç�': 'hidden field', 'fonte': 'hidden field', 'revisão': 'no label', });
lyr_EquipPubEsportejan23_11.set('fieldLabels', {'id': 'inline label - always visible', 'name': 'inline label - always visible', 'layer': 'inline label - always visible', 'bairro': 'hidden field', 'fonte': 'hidden field', 'distrito': 'hidden field', 'obs': 'hidden field', 'revisão': 'hidden field', 'org.': 'hidden field', 'Macrozona': 'hidden field', });
lyr_EquipPubPraasParquesoutrosjan23_12.set('fieldLabels', {'id': 'inline label - always visible', 'name': 'inline label - always visible', 'bairro': 'hidden field', 'fonte': 'hidden field', 'layer_': 'inline label - always visible', 'distrito': 'hidden field', 'observaç�': 'hidden field', 'revisão': 'hidden field', 'estrutura': 'hidden field', 'org.': 'hidden field', 'Macrozona': 'hidden field', });
lyr_EquipPubCulturaisout21_13.set('fieldLabels', {'id': 'inline label - always visible', 'uso': 'inline label - always visible', 'tipo': 'inline label - always visible', 'fonte': 'hidden field', 'origem': 'hidden field', 'bairro': 'hidden field', 'distrito': 'hidden field', 'observaç�': 'hidden field', 'turno': 'hidden field', 'endereço': 'hidden field', 'capacidade': 'hidden field', 'gestão': 'inline label - always visible', 'equipament': 'inline label - always visible', 'org.': 'hidden field', });
lyr_EquipPubAssistSocialout23_14.set('fieldLabels', {'id': 'hidden field', 'unidade': 'inline label - always visible', 'local': 'inline label - always visible', 'contato': 'hidden field', 'obs.': 'hidden field', 'tipo': 'inline label - always visible', 'bairro': 'inline label - always visible', 'distrito': 'inline label - always visible', 'org.': 'inline label - always visible', 'Abrangenci': 'inline label - always visible', 'link': 'inline label - always visible', });
lyr_EquipEducaoout23_15.set('fieldLabels', {'id': 'inline label - always visible', 'tipo': 'inline label - always visible', 'cod_inep': 'hidden field', 'nome_compl': 'inline label - always visible', 'distrito': 'hidden field', 'numero': 'hidden field', 'bairro': 'hidden field', 'nome_anter': 'hidden field', 'salas': 'hidden field', 'endereco': 'hidden field', 'turmas_exi': 'hidden field', 'gestão': 'inline label - always visible', 'org.': 'hidden field', 'LINK': 'hidden field', 'Obs.': 'hidden field', });
lyr_EquipPubSadeout23_16.set('fieldLabels', {'id': 'inline label - always visible', 'name': 'inline label - always visible', 'descriptio': 'inline label - always visible', 'tipo': 'inline label - always visible', 'fonte': 'hidden field', 'bairro': 'hidden field', 'distrito': 'hidden field', 'cnes': 'hidden field', 'n. gestão': 'inline label - always visible', 'org.': 'hidden field', 'LINK': 'hidden field', 'LINK_2': 'hidden field', });
lyr_ProjetosREFLORACamaari2023_17.set('fieldLabels', {'Long': 'hidden field', 'Lat': 'hidden field', 'Tipo': 'inline label - always visible', 'Projeto': 'inline label - always visible', });
lyr_PraasdePedgiorodestaduais_18.set('fieldLabels', {'id': 'inline label - always visible', 'nome': 'inline label - always visible', 'tipo': 'inline label - always visible', 'bairro': 'inline label - always visible', 'distrito': 'inline label - always visible', 'base': 'inline label - always visible', 'fonte': 'inline label - always visible', });
lyr_LogradourosHierarquizao_19.set('fieldLabels', {'id': 'hidden field', 'codlog_': 'inline label - always visible', 'logradour_': 'inline label - always visible', 'parcelame_': 'inline label - always visible', 'bairro_': 'inline label - always visible', 'distrito_': 'inline label - always visible', 'cep_': 'inline label - always visible', 'obs_1': 'inline label - always visible', 'obs_2': 'inline label - always visible', 'webmap': 'inline label - always visible', 'class.2': 'inline label - always visible', 'compriment': 'inline label - always visible', 'MAPA': 'inline label - always visible', });
...
lyr_Paradasdenibusemrodovias2022_24.set('fieldLabels', {'id': 'hidden field', 'name': 'hidden field', 'via': 'hidden field', 'bairro_loc': 'hidden field', 'distrito': 'hidden field', 'bases': 'hidden field', 'org.': 'hidden field', });
